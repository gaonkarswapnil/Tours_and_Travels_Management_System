<?php
	...
	$train=$_SESSION["session_train"];
	if (isset($_POST['checkout'])) {
		header("location:bookTrain.php");
	}
?>
...
<head lang="en">
	...
	<body>
		...
		<form class="form-horizontal"  method="POST">
			<div class="form-group">
					<div class="media-left media-middle">
						...
						$sql = "SELECT * FROM ADD_TRAIN WHERE AFROM='$from' AND ATO='$to' AND TRAINNAME='$train'";
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								...
								echo '<td colspan="2" align="center"><h3>'.$row["TRAINNAME"].'</h3></td></tr>';
								...
								echo '<tr><td align="center"><b>Sleeper Train </b></td><td><input type="textbox" class="no-outline" value='.$row["SLEEPER"].' readonly></td></tr>';
								echo '<tr><td align="center"><b>Sitting Train </b></td><td><input type="textbox" class="no-outline" value='.$row["SITTING"].' readonly></td></tr>';
								echo '<tr><td align="center"><b>Ac Train </b></td><td><input type="textbox" class="no-outline" value='.$row["AC"].' readonly></td></tr>';
		...
		<footer class="text-center" id="footerID">
			<a href="viewTrain.php" data-toggle="tooltip" title="TO TOP">
