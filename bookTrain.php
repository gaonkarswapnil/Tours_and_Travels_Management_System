<?php
	...
	if (isset($_POST['book'])) {
		...
		$query = "INSERT INTO TRAINBOOK (CUSTOMER, NAME, AFROM, DEPTIME, ATO, ARRIVALTIME, DATEOFTRAVEL, NOOFPASSENGER, TRAINCLASS, INCLUDEFOOD)
			VALUES('$email', '$name', '$from', '$deptime', '$to', '$artime', '$dot', '$noofpassenger', '$class', '$food')";
		$sql=mysqli_query($con, $query);
		if ($sql) {
			header("location:traincard.php");
		}
		else{
			echo "error";
		}
