<?php
	...
	if (isset($_POST['book'])) {
		...
		$query = "INSERT INTO FLIGHTBOOK (CUSTOMER, Name, AFROM, DEPTIME, ATO, ARRIVALTIME, DATEOFTRAVEL, NOOFPASSENGER, FLIGHTCLASS, INCLUDEFOOD)
			VALUES('$email', '$name', '$from', '$deptime', '$to', '$artime', '$dot', '$noofpassenger', '$class', '$food')";
		$sql=mysqli_query($con, $query);
		if ($sql) {
			header("location:flightcard.php");
		}
		else{
			echo "error";
		}
...
<head lang="en">
	...
	<body>
		...
		<form class="form-horizontal"  method="POST">
			...
			<div class="form-group">
				<label class="control-label col-sm-4" for="class">Select Class:</label>
				<div class="col-sm-6">
		...
		<footer class="text-center" id="footerID">
			<a href="bookFlight.php" data-toggle="tooltip" title="TO TOP">
