...
<head lang="en">
	...
	<body>
		...
		<form class="form-horizontal"  method="POST">
				 <div class="form-group">
					...
					<div class="col-sm-6">
						<?php
							...
							$sql = "SELECT DISTINCT(AFROM) FROM ADD_BUS ORDER BY AFROM";
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<?php
							...
							$sql = "SELECT DISTINCT(ATO) FROM ADD_BUS ORDER BY ATO";
							$result = $con->query($sql);
				...
				<div class="form-group">
						<label class="control-label col-sm-4" for="to">Bus Name:</label>
						<div class="col-sm-6">	
							<?php
								include ('C:\xampp\htdocs\tour\database\config.php');
								if ($con->connect_error) {
								...
								$sql = "SELECT DISTINCT(BUSNAME) FROM ADD_BUS ORDER BY BUSNAME";
								$result = $con->query($sql);
		...
		<footer class="text-center" id="footerID">
			<a href="Bus1.php" data-toggle="tooltip" title="TO TOP">
