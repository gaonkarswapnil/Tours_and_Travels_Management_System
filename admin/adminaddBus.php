...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO ADD_BUS (BUSNAME, AFROM, DEPTIME, ATO , ARRIVALTIME, IMAGE, SLEEPER, AC, DELUXE, FOOD) 
		VALUES ('$busname', '$from', '$atime', '$to', '$dtime', '$image', '$sleeper', '$ac', '$deluxe', '$food')";
	//header("location:index.php");
    $sql=mysqli_query($con, $query);
    if ($sql) {
    //$msg="<div class='alert alert-success'><b>Successfully Register</b></div>";
	echo '<script>alert("Successfully Added");location="admineditBus.php";</script>';
...
<head lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<form class="form-horizontal"  method="POST">
				<div class="form-group">
					<label class="control-label col-sm-4" for="name_of_bus">Name of BUS:</label>
					<div class="col-sm-6">
						<input type="textbox" class="form-control" id="name_of_bus" name="name_of_bus" placeholder="Name of BUS" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="textbox" class="form-control" id="from" name="from" placeholder="Enter Bus Stop" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="textbox" class="form-control" id="to" name="to" placeholder="Enter Bus Stop" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="deluxe">Deluxe:</label>
					<div class="col-sm-6">
		...
		<footer class="text-center" id="footerID">
			<a href="adminaddBus.php" data-toggle="tooltip" title="TO TOP">
