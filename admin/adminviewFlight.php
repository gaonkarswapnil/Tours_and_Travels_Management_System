...
<head lang="en">
	...
	<body>
			...
			if ($result->num_rows > 0) {
				echo '<table class="w3-table-all w3-xlarge" align="center" border="2">
					...
					echo "<tr id='data'>
						...
						<td>".$row['DATEOFTRAVEL']."</td>
						<td>".$row['NOOFPASSENGER']."</td>
						<td>".$row['FLIGHTCLASS']."</td>
						<td>".$row['INCLUDEFOOD']."</td>
					</tr>";
				}
				echo "</table>";
			} else {
		...
		<footer class="text-center" id="footerID">
			<a href="adminviewFlight.php" data-toggle="tooltip" title="TO TOP">
